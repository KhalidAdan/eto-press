...
everywhere, and a paper that installs `@eto-press/cli` has `eto` in its
...
| verb | what it does |
| --- | --- |
| `eto init` | a paper comes into existence (asks five questions) |
...
| `eto render` | render the public site from the journal, stylesheet and fonts included |
